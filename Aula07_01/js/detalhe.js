...
function detalhesFilme(){
    fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=e8ee1b7136ab091a2fb872089bf3c840&language=pt-BR`)
    ...
    .then((resultado)=>{
        ...
        main.innerHTML=`<div id="img">
                        ...
                        <div id="content">
                            <h4>${resultado.title}<span class=texto>(${resultado.release_date.substring(0,4)})</span></h4>
                            <p id="genero">
                                <ul>${genero}</ul>
                            </p>
                            <p id="avaliacao">
